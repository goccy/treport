...
var (
	...
	file_size_proto_rawDescData = file_size_proto_rawDesc
)

func file_size_proto_rawDescGZIP() []byte {
	file_size_proto_rawDescOnce.Do(func() {
		file_size_proto_rawDescData = protoimpl.X.CompressGZIP(file_size_proto_rawDescData)
	})
